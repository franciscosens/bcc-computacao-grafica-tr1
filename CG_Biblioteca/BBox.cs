...
namespace CG_Biblioteca
{
    public class BBox
    {
        ...
        public void Atribuir(Ponto4D pontoMin, Ponto4D pontoMax)
        {
            this.menorX = pontoMin.X;
            this.menorY = pontoMin.Y;
            this.menorZ = pontoMin.Z;
            this.maiorX = pontoMax.X;
            this.maiorY = pontoMax.Y;
            this.maiorZ = pontoMax.Z;
        }
